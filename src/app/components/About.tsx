                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="max-w-[800px] ">
                                        ...
                                        <p className="text-gray-600 md:w-[460px] text-justify font-medium">
                                            Hi! My name is Salman Ahmed. I am a web Developer, and I&apos;m
                                            very passionate and doing my work with more than 1 year
                                            experience as a professional
                                        </p>
                                        <button className="bg-[#ff4D41] text-white py-2 px-4 rounded inline-block mt-10 font-medium border border-[#ff4D41] hover:bg-transparent hover:text-[#ff4D41] transition duration-200"><Link href={"/"} title="click to visit">Hire Me</Link></button>
                                    </div>
                                </div>
                            </RevealWrapper>
                        </div>
